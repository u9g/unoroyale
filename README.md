...
- **Ranked mode** — a heads-up trophy ladder through six rooms, each with its own result card, played against a server-run opponent (see [uno-stats](https://github.com/u9g/uno-stats)), where climbing puts you against sharper opponents, played under a name claimed once per install
